      ...
      <div>
        ...
        {splitText.map((element) => {
          return (
            ...
            <p>{element}</p>
            <img src='https://maps.googleapis.com/maps/api/place/photo?maxwidth=400&photoreference=CmRaAAAAOwjuA2IoZHb9SdgIvNvYxEN--cvzV2-Y3R4mPs0modJaz4n1gY6n2Ngc9bG927NSSrYh8Hv0APDrC_EYf8m1Bg7cO8jqqE4ra_5UJunUMkhlynnhp2yAyK6RGShGFth7EhDNCP2KQPX8ae1BTlCDYtX6GhRaDhJ-4cU9IvKroOO7rZObX2ihOg&key=AIzaSyDkru4DlzkS1qHU--pZk8uhuBh01KOdz0Q'/> 
            </div>)
        })
        }
      </div>
